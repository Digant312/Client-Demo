...
import FutureHeader from 'containers/Protected/Portfolio/EditTransaction/Fields/futureHeader'
...
const messages = defineMessages({
  contractValue: {
    id: 'futuresTransactionForm.contractValue',
...
> {
  ...
  getFormattedMessage(type: string) {
    switch (type) {
      case 'New':
        return formMessages.newFuturesTransaction
      case 'Edit':
        return formMessages.editFuturesTransaction
      case 'ReadOnly':
      default:
        return formMessages.readOnlyFuturesTransaction
    }
  }
                  ...
                  <Grid columns={4} divided>
                    <Grid.Row>
                      ...
                      <Grid.Column>
                        ...
                        <ActionQuantityGroup
                          readOnly={isReadOnly}
                          actionOptions={futureActionOptions}
                        />

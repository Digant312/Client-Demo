...
> {
  ...
  getFormattedHeaderMessage(type: string) {
    switch (type) {
      case 'New':
        return messages.newEquityTransaction
      case 'Edit':
        return messages.editEquityTransaction
      case 'ReadOnly':
      default:
        return messages.readOnlyEquityTransaction
    }
  }
      ...
      <div className="edit-transaction-container" style={{ padding: '20px' }}>
        ...
        <Segment.Group size="tiny">
          <Segment inverted={darkProfile}>
            <h3>
              <FormattedMessage {...this.getFormattedHeaderMessage(type)} />
            </h3>
          </Segment>
                    ...
                    <Grid.Row>
                      ...
                      <Grid.Column>
                        ...
                        <TransactionAssetDropdown
                          queryFilter={{
                            assetType: ['Equity', 'ExchangeTradedFund']
                          }}
                          readOnly={isReadOnly}
                        />
